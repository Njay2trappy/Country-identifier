...
function validateCountryResponses(countries) {
    const requiredFields = ['name', 'population', 'currencyCode'];
    const details = {};
...
function parseSortParameter(sortParam) {
    ...
    switch (normalized) {
        ...
        default:
            throw new Error(`Invalid sort parameter: ${sortParam}. Valid options are: name_asc, name_desc, population_asc, population_desc, gdp_asc, gdp_desc`);
    }
}
